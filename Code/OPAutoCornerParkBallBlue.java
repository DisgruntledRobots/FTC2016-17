...
@Autonomous(name="Test OPAutoCornerParkBallBlue", group="Linear Opmode")  // @Autonomous(...) is the other common choice
//@Disabled
public class OPAutoCornerParkBallBlue extends LinearOpMode {
