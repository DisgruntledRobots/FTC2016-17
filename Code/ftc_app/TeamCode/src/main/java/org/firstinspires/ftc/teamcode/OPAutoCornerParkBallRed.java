...
@Autonomous(name="Test OPAutoCornerParkBallRed", group="Linear Opmode")  // @Autonomous(...) is the other common choice
//@Disabled
public class OPAutoCornerParkBallRed extends LinearOpMode {
