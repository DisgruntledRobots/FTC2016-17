...
@Autonomous(name="Test OPAutoCornerParkBlue", group="Linear Opmode")  // @Autonomous(...) is the other common choice
//@Disabled
public class OPAutoCornerParkBlue extends LinearOpMode {
